...
:timer.tc fn -> Barcalc.PConvert.standard_drinks Enum.take(Stream.cycle([{margarita, 1}]), 3) end
:timer.tc fn -> Barcalc.PConvert.pstandard_drinks Enum.take(Stream.cycle([{margarita, 1}]), 3) end
